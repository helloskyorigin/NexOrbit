...
export const AICommandInput: React.FC<AICommandInputProps> = ({
  ...
  return (
    <div className={cn('w-full flex flex-col gap-2.5', className)}>
      ...
      <div className="relative w-full rounded-2xl bg-white border border-slate-200/90 shadow-xs focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-500/10 transition-all duration-200">
